...
const SideBar = () => {
    ...
    const sideClassName = `fixed flex flex-col h-[100%] justify-between shadow-xl transition-all duration-300
    ...
    <div className={sideClassName}>
        <div className='flex h-[100%] w-full flex-col justify-start'>
            ...
            <div className='z-50 flex min-h-[56px] w-64 items-center justify-between bg-white px-6 pt-3 dark:bg-black'>
                ...
                {isSidebarCollapsed ? null : (
                    <button className='py-3' onClick={() => {dispatch(setIsSidebarCollapsed(!isSidebarCollapsed))}}>
                        <X className='h-6 w-6 text-grey-800 hover:text-gray-500 dark:text-white' />
                    </button>
                )}
            </div>
            {/*Team*/}
            <div className='flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700'>
                ...
                <div>
                    <h3 className='text-md font-bold tracking-wide dark:text-gray-200'>Vamshi Team</h3>
            ...
            <button onClick={() => setShowProjects((prev) => !prev)}
                className='flex w-full item-center justify-between px-8 py-3 text-gray-500'>
